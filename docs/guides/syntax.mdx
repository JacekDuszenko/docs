...
-   `spec` is an array of [Aladino](/guides/aladino-language) specifications.
...
-   `where` is an [Aladino](/guides/aladino-language) boolean expression that uses the _param_ variable to define a condition on which developers should be part of the group.
...
-   `spec` is a boolean expression in [Aladino](/guides/aladino-language).
...
The `run` field can be a single action or a list of actions. An action is an [Aladino](/guides/aladino-language) expression to be executed.

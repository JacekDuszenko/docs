...
If you wish to retrieve the list of all reviewers on a pull request, you can create a [`group`](/guides/syntax#group) and use both [`reviewers`](/guides/built-ins#review) and [`requestedReviewers`](/guides/built-ins#requestedreviewers) built-ins.
